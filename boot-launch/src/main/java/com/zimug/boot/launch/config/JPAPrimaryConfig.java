...
@EnableJpaRepositories(basePackages = "com.zimug.boot.launch.dao.testdb",  //注意这里
...
public class JPAPrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManager() throws Throwable {
        ...
        //这里要修改成主数据源的扫描包
        entityManager.setPackagesToScan("com.zimug.boot.launch.dao.testdb");
